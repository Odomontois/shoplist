...
var G__13916 = f;
var G__13917 = (16);
return setTimeout(G__13916,G__13917);
});
...
var or__3743__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__3743__auto__)){
return or__3743__auto__;
} else {
var or__3743__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__3743__auto____$1)){
return or__3743__auto____$1;
} else {
var or__3743__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__3743__auto____$2)){
return or__3743__auto____$2;
} else {
var or__3743__auto____$3 = (w["msRequestAnimationFrame"]);
...
var n__4630__auto__ = a.length;
var i = (0);
while(true){
if((i < n__4630__auto__)){
var c_13918 = (a[i]);
if(cljs.core.truth_((c_13918["cljsIsDirty"]))){
(c_13918["forceUpdate"])();
} else {
}
...
var G__13920 = ((function (this$){
return (function (){
return this$.run_queue();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__13920) : reagent.impl.batching.next_tick.call(null,G__13920));
}
});
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__4330__auto__,writer__4331__auto__,opt__4332__auto__){
return cljs.core._write(writer__4331__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__13922 = c;
var G__13922__$1 = (((G__13922 == null))?null:(G__13922["props"]));
var G__13922__$2 = (((G__13922__$1 == null))?null:(G__13922__$1["argv"]));
return G__13922__$2;
});
...
var G__13924_13925 = (c["cljsRatom"]);
var G__13924_13926__$1 = (((G__13924_13925 == null))?null:reagent.ratom.dispose_BANG_(G__13924_13925));
