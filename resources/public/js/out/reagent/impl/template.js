...
var or__3743__auto__ = (function (){var G__13934 = n;
return (reagent.impl.template.attr_aliases.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.attr_aliases.cljs$core$IFn$_invoke$arity$1(G__13934) : reagent.impl.template.attr_aliases.call(null,G__13934));
})();
...
var G__13937 = o;
(G__13937[(function (){var G__13938 = k;
return (reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1(G__13938) : reagent.impl.template.cached_prop_name.call(null,G__13938));
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__13939){
var vec__13941 = p__13939;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13941,(0),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13941,(1),null);
var pid = (props["id"]);
...
var pname_13944 = (function (){var G__13943 = k;
return (reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1(G__13943) : reagent.impl.template.cached_prop_name.call(null,G__13943));
})();
if(!((pname_13944 === "key"))){
(o[pname_13944] = reagent.impl.template.convert_prop_value(v));
} else {
}
...
var res = (function (){var G__13946 = e;
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__13946) : on_change.call(null,G__13946));
})();
...
var G__13949 = jsprops;
(G__13949["defaultValue"] = value);

(G__13949["value"] = null);

(G__13949["onChange"] = ((function (G__13949,on_change,value){
return (function (p1__13947_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13947_SHARP_);
});})(G__13949,on_change,value))
);
...
var jsargs = (function (){var G__13955 = argv;
var G__13956 = ((hasprops)?(2):(1));
var G__13957 = ((inprops["level"]) + (1));
return (reagent.impl.template.convert_args.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.convert_args.cljs$core$IFn$_invoke$arity$3(G__13955,G__13956,G__13957) : reagent.impl.template.convert_args.call(null,G__13955,G__13956,G__13957));
})();
var jsprops = reagent.impl.template.convert_props(((hasprops)?props:null),id_class);
if((input_setup == null)){
} else {
var G__13958_13960 = this$;
var G__13959_13961 = jsprops;
(input_setup.cljs$core$IFn$_invoke$arity$2 ? input_setup.cljs$core$IFn$_invoke$arity$2(G__13958_13960,G__13959_13961) : input_setup.call(null,G__13958_13960,G__13959_13961));
}
...
var or__3743__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(cljs.core.truth_(or__3743__auto__)){
return or__3743__auto__;
} else {
var a1 = (c["props"]["argv"]);
...
var G__13963 = spec;
(G__13963["componentDidUpdate"] = ((function (G__13963){
return (function (){
var c = this;
...
(G__13963["componentWillUnmount"] = ((function (G__13963){
return (function (){
var c = this;
...
var spec = {"displayName": (function (){var or__3743__auto__ = name;
if(cljs.core.truth_(or__3743__auto__)){
return or__3743__auto__;
} else {
...
return (function (p1__13964_SHARP_,p2__13965_SHARP_){
var C = this;
return reagent.impl.template.wrapped_should_update(C,p1__13964_SHARP_,p2__13965_SHARP_);
...
var vec__13967 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13967,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13967,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13967,(2),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__3743__auto__ = id;
if(cljs.core.truth_(or__3743__auto__)){
return or__3743__auto__;
} else {
...
var vec__13969 = reagent.impl.template.parse_tag(tag);
var comp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13969,(0),null);
var id_class = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13969,(1),null);
...
var res = (function (){var G__13971 = withrender;
return (reagent.impl.template.create_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.create_class.cljs$core$IFn$_invoke$arity$1(G__13971) : reagent.impl.template.create_class.call(null,G__13971));
})();
...
var G__13973 = tag;
return (reagent.impl.template.cached_wrapper.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_wrapper.cljs$core$IFn$_invoke$arity$1(G__13973) : reagent.impl.template.cached_wrapper.call(null,G__13973));
} else {
...
var k_13976 = reagent.impl.template.get_key(cljs.core.meta(v));
var k_SINGLEQUOTE__13977 = (((k_13976 == null))?reagent.impl.template.get_key(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(1),null)):k_13976);
if((k_SINGLEQUOTE__13977 == null)){
} else {
(jsprops["key"] = k_SINGLEQUOTE__13977);
}

var G__13975 = jsprops;
return (c.cljs$core$IFn$_invoke$arity$1 ? c.cljs$core$IFn$_invoke$arity$1(G__13975) : c.call(null,G__13975));
});
...
var G__13984 = x;
var G__13985 = level;
return (reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2 ? reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2(G__13984,G__13985) : reagent.impl.template.expand_seq.call(null,G__13984,G__13985));
} else {
var s = reagent.ratom.capture_derefed((function (){
var G__13986 = x;
var G__13987 = level;
return (reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2 ? reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2(G__13986,G__13987) : reagent.impl.template.expand_seq.call(null,G__13986,G__13987));
}),reagent.impl.template.seq_ctx);
...
var n__4630__auto___13988 = a.length;
var i_13989 = (0);
while(true){
if((i_13989 < n__4630__auto___13988)){
(a[i_13989] = reagent.impl.template.as_component.cljs$core$IFn$_invoke$arity$2((a[i_13989]),level_SINGLEQUOTE_));
