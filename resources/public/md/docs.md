<div class="bs-callout bs-callout-danger">
 ...
 <ol>
   ...
   <li> Add the connection parameters in the <code>shoplist.db.core</code> namespace.
...
Request middleware functions are located under the `shoplist.middleware` namespace.
